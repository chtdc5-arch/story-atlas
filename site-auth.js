(() => {
  ...
  let loading=false;
  const scripts=['supabase-config.js','https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2','roadmap-data.js?v=20260909','roadmap.js?v=20260909','published-story-data.js?v=20260910-17','published-story-overrides.js?v=20260911','app.js?v=20260910-17'];
