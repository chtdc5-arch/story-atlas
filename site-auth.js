(() => {
  ...
  let loading=false;
  const scripts=['supabase-config.js','https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2','roadmap-data.js?v=20260909','roadmap.js?v=20260909','published-story-data.js?v=20260910-17','published-story-overrides.js?v=20260916','published-comic-data.js?v=20260923-p01-p16-v3','app.js?v=20260923-comic-pages-v2'];
